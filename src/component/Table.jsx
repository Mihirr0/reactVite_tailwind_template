                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {people.map((person) => (
                    <tr key={person.email}>
                      ...
                      <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">{person.rating}</td>
                      <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">{person.earning}</td>
                      <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">{person.visitor}</td>
